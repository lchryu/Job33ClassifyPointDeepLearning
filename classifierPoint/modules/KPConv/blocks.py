...
from classifierPoint.core.common_modules.base_modules import (
    BaseModule,
    FastBatchNorm1d,
)
from classifierPoint.core.spatial_ops import RadiusNeighbourFinder
from classifierPoint.core.data_transform import VoxelGrid
from classifierPoint.utils.enums import ConvolutionFormat
from classifierPoint.core.base_conv.message_passing import GlobalBaseModule
from classifierPoint.core.common_modules.base_modules import Identity
...
class SimpleBlock(BaseModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if is_strided:
            self.sampler = VoxelGrid(grid_size)
        else:
            self.sampler = None
