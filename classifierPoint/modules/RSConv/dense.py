...
from classifierPoint.core.base_conv.dense import *
from classifierPoint.core.common_modules.dense_modules import MLP2D
from classifierPoint.core.spatial_ops import (
    DenseFPSSampler,
...
class RSConvSharedMSGDown(BaseDenseConvolutionDown):
    ...
    def __repr__(self):
        return "{}({}, shared: {}, {} )".format(
            self.__class__.__name__, self.mlps.__repr__(), self.mlp_out.__repr__(), self._mapper.__repr__()
        )
...
class RSConvOriginalMSGDown(BaseDenseConvolutionDown):
    ...
    def __repr__(self):
        return "{}: {} ({}, shared: {})".format(
            self.__class__.__name__, self.nb_params, self.mlps.__repr__(), self.mappings.__repr__()
        )
