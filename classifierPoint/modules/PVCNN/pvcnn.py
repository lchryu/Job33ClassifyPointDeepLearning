...
from classifierPoint.modules.PVCNN.blocks import *
    ...
    def __init__(self, option, dataset):
        ...
        self.point_transforms = nn.ModuleList(
            [
                ...
                # nn.Sequential(nn.Linear(cs[0], cs[4]), nn.GroupNorm(8, cs[4]), nn.ReLU(True),),
                # nn.Sequential(nn.Linear(cs[4], cs[6]), nn.GroupNorm(8, cs[6]), nn.ReLU(True),),
                # nn.Sequential(nn.Linear(cs[6], cs[8]), nn.GroupNorm(8, cs[8]), nn.ReLU(True),),
            ]
        )
