...
def collate(
    ...
    for out_store in out.stores:
        ...
        for attr in stores[0].keys():
            ...
            if attr in follow_batch and isinstance(slices, Tensor) and slices.dim() == 1:
...
def _collate(
    ...
    elif isinstance(elem, Sequence) and not isinstance(elem, str) and isinstance(elem[0], (Tensor, SparseTensor)):
