...
from classifierPoint.utils.registration import (
    estimate_transfo,
...
class PatchRegistrationTracker(BaseTracker):
    def __init__(self, dataset, stage="train", use_tensorboard: bool = False):
        ...
        super(PatchRegistrationTracker, self).__init__(stage, use_tensorboard)
...
class FragmentRegistrationTracker(BaseTracker):
    def __init__(
        ...
        """
        super(FragmentRegistrationTracker, self).__init__(stage, use_tensorboard)
