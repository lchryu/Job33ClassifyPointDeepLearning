...
class ModelInference(object):
    ...
    def __init__(
        ...
        from classifierPoint.utils.mock import MockDataset
        import classifierPoint.metrics.model_checkpoint as model_checkpoint
...
class PointNetForward(ModelInference):
    ...
    def __init__(
        ...
        from classifierPoint.datasets.base_dataset import BaseDataset
        from torch_geometric.transforms import FixedPoints, VoxelGrid

        self.inference_transform = BaseDataset.remove_transform(self.inference_transform, [VoxelGrid, FixedPoints])
