...
from classifierPoint.applications.modelfactory import ModelFactory
from classifierPoint.modules.pointnet2 import *
from classifierPoint.core.base_conv.dense import DenseFPModule
...
from classifierPoint.core.common_modules.dense_modules import Conv1DBNReLU
from classifierPoint.core.common_modules.base_modules import Seq
    ...
    def _build_unet(self):
        if self._config:
            ...
            path_to_model = os.path.join(
                PATH_TO_CONFIG,
                "unet_{}_{}.yaml".format(self.num_layers, "ms" if self.kwargs["multiscale"] else "ss"),
            )
...
class BasePointnet2(UnwrappedUnetBasedModel):
    ...
    def __init__(self, model_config, model_type, dataset, modules, *args, **kwargs):
        ...
        if "output_nc" in kwargs:
            ...
            self.mlp = Seq()
            self.mlp.append(Conv1DBNReLU(default_output_nc, self._output_nc, bn=True, bias=False))
