...
from classifierPoint.applications.minkowski import Minkowski
from classifierPoint.core.common_modules import Seq, MLP
from classifierPoint.core.losses import offset_loss, instance_iou_loss
from classifierPoint.core.data_transform import VoxelGrid
from .structures import PanopticLabels, PanopticResults
from classifierPoint.utils import is_list
...
class PointGroup(BaseModel):
    ...
    def __init__(self, option, model_type, dataset, modules):
        ...
        if cluster_voxel_size:
            self._voxelizer = VoxelGrid(cluster_voxel_size, quantize_coords=True, mode="mean")
        else:
    ...
    def set_input(self, data, device):
        ...
        self.input = data
        all_labels = {i: data[i].to(device) for i in self.__REQUIRED_LABELS__}
