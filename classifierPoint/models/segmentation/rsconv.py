...
from classifierPoint.models.base_architectures import UnwrappedUnetBasedModel
...
class RSConvLogicModel(UnwrappedUnetBasedModel):
    def __init__(self, option, model_type, dataset, modules):
        ...
        for i in range(1, len(last_mlp_opt.nn)):
            self.FC_layer.append(Conv1DBNReLU(last_mlp_opt.nn[i - 1], last_mlp_opt.nn[i], bn=True, bias=False))
