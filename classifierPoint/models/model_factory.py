...
from classifierPoint.utils.model_building_utils.model_definition_resolver import (
    resolve_model,
)
...
def instantiate_model(config, dataset) -> BaseModel:
    ...
    tested_model_name = config.models.items()[0][0]
    ...
    model_module = ".".join(["classifierPoint.models", task, module])
