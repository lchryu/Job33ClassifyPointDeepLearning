...
from classifierPoint.models.base_architectures import BaseFactory
...
class BackboneBasedModel(BaseModel):
    ...
    def _init_from_compact_format(self, opt, model_type, dataset, modules_lib):
        ...
        (
            self.metric_loss_module,
            self.miner_module,
        ) = BaseModel.get_metric_loss_and_miner(getattr(opt, "metric_loss", None), getattr(opt, "miner", None))
